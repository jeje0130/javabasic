...
public class ArrayListClass {
	...
	public static void main(String[] args) {
		...
		sample.add("abc");                   //모든 타입의 값 저장
		sample.add(100);
		sample.add(new Scanner(System.in));
		
		//제네릭을 지정하지 않으면 넣을때는 편하나 꺼낼때는 타입을 예측하기 힘들다.
		//따라서 제네릭의 사용이 권장된다.
		ArrayList<Integer> list = new ArrayList<>();  //Integer만 저장하겠다고 지정하는것
		list.add(10);
//		list.add("abc");
		list.add(20);
...
//		list.add(5,50); --인덱스 뛰어넘어서 저장하는것은 안된다.
...
//		}
		...
		li.add(10); //오토박싱 : 기본형타입이 wrapper 클래스로 자동변환
		
		Integer _integer = li.get(0);
		int _int = li.get(0); //언박싱 : wrapper클래스가 기본형타입으로 자동 변환
