...
public class Store {
	...
	public static void main(String[] args) {
		Desktop d1 = new Desktop("삼성 컴퓨터", 120000);
		Desktop d2 = new Desktop("LG 컴퓨터", 150000);

		AirCon ac1 = new AirCon("삼성 에어컨", 230000);
		AirCon ac2 = new AirCon("LG 에어컨", 250000);
		
		TV tv1 = new TV("삼성 TV", 330000);
		TV tv2 = new TV("LG TV", 370000);
...
class Customer{
	...
	Product[] item = new Product[100]; //장바구니
