...
public class JVM {
	...
	public static void main(String[] args) {
		...
		//20. instanceMethod()의 실행이 종료되어 CallStack에 삭제됨
		
		jvm = null;
		//21. jvm변수에 null이 저장됨
		//22. 어디에서도 주소를 참조하지 않는 JVM객체는 GarbageCollector에 의해 삭제됨
		
		//23. main()의 실행이 종료되어 CallStack에 삭제됨
		//24. 프로그램이 종료되고 MethodArea의 데이터가 삭제됨

	}
	
	int instanceVar; //클래스에 객체생성을 했을때 메모리에 올라감
	static int classVar;
...
//		System.out.println(new JVM().instanceVar);
